...
import { FiCalendar, FiList, FiSearch, FiFilter, FiPlus } from 'react-icons/fi'
      ...
      <div className="flex-1 p-8 bg-gray-50 overflow-auto">
        {view === 'list' ? (
          <div className="text-center py-20 bg-white rounded-xl border border-gray-200 border-dashed">
            ...
            <h3 className="text-lg font-medium text-gray-900">List View</h3>
            <p className="text-gray-500 mt-1">Your events list will appear here.</p>
          </div>
        ) : (
          <CalendarView />
        )}
